...
class MusicBot(discord.Client):
    ...
    async def cmd_help(self, command=None):
        ...
        if command:
            ...
            helpmsg += "```"
            helpmsg += "Bot coded by Skalirow. Twitter: https://twitter.com/Skalirow?lang=en Pfp created by Tehosc. Twitter: https://twitter.com/oscarmakes?lang=en Bot is in early access, contact Skalirow for more info. Source Code:https://github.com/Skalirow/Kiot . Bot v.1.0.1."
